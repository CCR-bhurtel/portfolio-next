...
function Projects(props) {
    const [projects, setProjects] = useState([
...

        {
            ...
            description: 'Get different ready made notion templates for different tasks in economic price. ',
        ...
        },
        {
            ...
            description: 'Currently offline (multiplayer on development) tic tac toe game build on next.js.',
        ...
        <div className="projects toggleOption projectwala" id="projects">
            ...
            <div className="pcontainer reveal">
                {newProjects.map((project, index) => {
                    return <GlassCard key={index} projectDetails={{ ...project, index }} />;
                })}
            </div>
